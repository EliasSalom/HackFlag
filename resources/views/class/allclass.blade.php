        	...
        	<div class="col-12">
	          	<div class="card">
		            <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="{{ url('/class/addclass') }}">Add Class</a></h3>
		            </div>
                				...
                				<?php if($get_class)
                				{
                					...
                					?>
						                <tr class="class_id_<?php echo $get_class->id; ?>">
						                  	...
						                  	<td>
									      		<a href="{{ route('class/editclass',$get_class->id) }}" class="actionbtn">
