        	...
        	<div class="col-12">
	          	<div class="card">
		            <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="{{ url('/candidate/adminaddcandidate') }}">Add Candidate</a></h3>
		            </div>
                				...
                				<?php if($get_candidates)
                				{
                					...
                					?>
						                <tr class="candidate_id_<?php echo $get_candidate->users_id; ?>">
									      	...
									      	<td>
									      		<a href="{{ route('candidate/admineditcandidate',$get_candidate->users_id) }}" class="actionbtn">
