        	...
        	<div class="row">
          		...
          		<div class="col-md-12">
            		<div class="card card-primary">
                        ...
                        @endif
			            <form method="POST" action="{{ route('canidate/updatecandate') }}" enctype="multipart/form-data" id="myform"  role="form">
    		 				{{ csrf_field() }}
			                ...
			                <div class="card-body">
			                  	...
			                  	<div class="form-group">
			                    	...
			                    	<div class="input-group">
                                        ...
                                        <img src="{{URL::asset('/user/'.$get_candidate->image.'')}}" width="100" height="100" />
