        	...
        	<div class="col-12">
	          	<div class="card">
		            <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="{{ url('/teacher/addteacher') }}">Add Teacher</a></h3>
		            </div>
                				...
                				<?php if($get_teachers)
                				{
                					...
                					?>
						                <tr class="teacher_id_<?php echo $get_teacher->id; ?>">
									      	...
									      	<td>
									      		<a href="{{ route('teacher/editteacher',$get_teacher->id) }}" class="actionbtn">
...
$(document).ready(function(){
	$(document).on('click', '.teacherstatus', function(){
		...
		$.ajax({
            ...
            data:{"_token": "{{ csrf_token() }}",teacher_id:teacher_id,status_id:status_id},
