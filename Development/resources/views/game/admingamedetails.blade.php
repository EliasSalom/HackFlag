        	...
        	<div class="col-12">
	          	<div class="card">
	          		 <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="{{ url('/game/adminaddgame') }}">Add Game</a></h3>
		            </div>
                					...
                					?>
		                				<tr class="game_id_<?php echo $get_game_detail->id; ?>">
		                					...
		                					<td><?php if(isset($get_game_detail->status) && $get_game_detail->status == 1){ ?>
									      	...
									      	<td>
									      		<a href="{{ route('game/admineditgame',$get_game_detail->id) }}" class="actionbtn">
