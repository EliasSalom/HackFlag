      	...
      	<div class="row">
        	<div class="col-md-12">
          		<div class="card card-outline card-info">
          			<form method="POST" action="<?php echo e(route('updategame')); ?>" enctype="multipart/form-data" id="myform"  role="form">
                         ...
                         <?php } ?>
			              	...
			              	<div class="form-group">
		                    	...
		                    	<div class="input-group">
                                    ...
                                    <img src="<?php echo e(URL::asset('/game/'.$get_game->game_image.'')); ?>" width="100" height="100" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/game/admineditgame.blade.php ENDPATH**/ ?>