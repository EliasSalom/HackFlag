...
<div class="login-box">
  	...
  	<div class="card">
    	<div class="card-body login-card-body">
			...
			<?php endif; ?>
    		 <form method="POST" action="<?php echo e(route('addlogin')); ?>" enctype="multipart/form-data" id="myform">
...
</html><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/admin/login.blade.php ENDPATH**/ ?>