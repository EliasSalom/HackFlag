        	...
        	<div class="col-12">
	          	<div class="card">
		            <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="<?php echo e(url('/candidate/addcandidate')); ?>">Add Candidate</a></h3>
		            </div>
                				...
                				<?php if($get_candidates)
                				{
                					...
                					?>
						                <tr class="candidate_id_<?php echo $get_candidate->id; ?>">
									      	...
									      	<td>
									      		<a href="<?php echo e(route('candidate/editcandidate',$get_candidate->id)); ?>" class="actionbtn">
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/candidate/allcandidate.blade.php ENDPATH**/ ?>