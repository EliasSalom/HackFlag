        	...
        	<div class="col-12">
	          	<div class="card">
	          		 <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="<?php echo e(url('/game/adminaddgame')); ?>">Add Game</a></h3>
		            </div>
                				...
                				<?php if($get_game_details)
                				{
                					...
                					?>
		                				<tr class="game_id_<?php echo $get_game_detail->id; ?>">
		                					...
		                					<td><?php echo $get_game_detail->first_name.''.$get_game_detail->last_name; ?></td>
		                					...
		                					<td><?php if(isset($get_game_detail->status) && $get_game_detail->status == 1){ ?>
									      	...
									      	<td>
									      		<a href="<?php echo e(route('game/admineditgame',$get_game_detail->id)); ?>" class="actionbtn">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/game/admingamedetails.blade.php ENDPATH**/ ?>