        	...
        	<div class="col-12">
	          	<div class="card">
		            <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="<?php echo e(url('/game/addgame')); ?>">Add Game</a></h3>
		            </div>
                					...
                					?>
		                				<tr class="game_id_<?php echo $get_game_detail->id; ?>">
		                					...
		                					<td><?php if(isset($get_game_detail->status) && $get_game_detail->status == 1){ ?>
									      	...
									      	<td>
									      		<a href="<?php echo e(route('game/editgame',$get_game_detail->id)); ?>" class="actionbtn">
...
$(document).ready(function(){
	$(document).on('click', '.gamestatus', function(){
		...
		$.ajax({
            type:'POST',
            url:"<?php echo e(route('gamestatus')); ?>",
            data:{"_token": "<?php echo e(csrf_token()); ?>",game_id:game_id,status_id:status_id},
	...
	$(document).on('click', '.gamestart', function(){
		...
		$.ajax({
            ...
            data:{"_token": "<?php echo e(csrf_token()); ?>",game_id:game_id,is_start:is_start},
            success:function(data)
            {          
                if(data == 0)
                {                	
...
$(document).ready(function(){
	$(document).on('click', '.deletedgame', function(){
		...
		function(){
			$.ajax({
				type:'POST',
				url:"<?php echo e(route('deletedgame')); ?>",
...
$(document).ready(function(){
	$(document).on('click', '.get_userdata', function(){
		var id = $(this).attr('id');		
			...
			$.ajax({
				type:'POST',
				url:"<?php echo e(route('game/getuserdetail')); ?>",
				data:{"_token": "<?php echo e(csrf_token()); ?>",id:id},
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/game/index.blade.php ENDPATH**/ ?>