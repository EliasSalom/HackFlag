        	...
        	<div class="row">
          		...
          		<div class="col-md-12">
            		<div class="card card-primary">
                        ...
                        <?php endif; ?>
			            <form method="POST" action="<?php echo e(route('canidate/updatecandate')); ?>" enctype="multipart/form-data" id="myform"  role="form">
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hackflag\resources\views/candidate/editcandidate.blade.php ENDPATH**/ ?>