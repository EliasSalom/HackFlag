        	...
        	<div class="row">
          		...
          		<div class="col-md-12">
            		<div class="card card-primary">
                        ...
                        <?php endif; ?>
			            <form method="POST" action="<?php echo e(route('teacher/updateteacher')); ?>" enctype="multipart/form-data" id="myform"  role="form">
			                ...
			                <div class="card-body">
			                  	...
			                  	<div class="form-group">
			                    	...
			                    	<div class="input-group">
                                        ...
                                        <img src="<?php echo e(URL::asset('/user/'.$get_teacher->image.'')); ?>" width="100" height="100" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/teacher/editteacher.blade.php ENDPATH**/ ?>