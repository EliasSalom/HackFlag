        	...
        	<div class="col-12">
	          	<div class="card">
		            <div class="card-header">
		              	<h3 class="card-title pull-right"><a class="btn btn-primary" href="<?php echo e(url('/candidate/adminaddcandidate')); ?>">Add Candidate</a></h3>
		            </div>
		              	...
		              	<table id="example1" class="table table-bordered table-striped">
                			...
                			<tbody>
                				<?php if($get_candidates)
                				{
                					...
                					{
                					?>
						                <tr class="candidate_id_<?php echo $get_candidate->users_id; ?>">
						                  	<td><?php echo $i; ?></td>
						                  	<td><?php echo $get_candidate->first_name; ?></td>
						                  	<td><?php echo $get_candidate->last_name; ?></td>
						                  	<td><?php echo $get_candidate->email; ?></td>
						                  	<td><?php echo $get_candidate->class_name.' '.$get_candidate->section_name; ?></td>
						                  	<td><?php if(isset($get_candidate->status) && $get_candidate->status == 1){ ?>
								      		<span class="managestatus_<?php echo $get_candidate->users_id; ?>"><a href="javascript:void(0);" id="<?php echo $get_candidate->users_id; ?>" data_active="0" class="btn btn-info candidatestatus">Active </a></span>
              								<?php } else{ ?>
              								<span class="managestatus_<?php echo $get_candidate->users_id; ?>"><a href="javascript:void(0);" id="<?php echo $get_candidate->users_id; ?>" data_active="1" class="btn btn-danger candidatestatus inactive">Inactive </a></span>
              								<?php } ?>
	              							</td>
									      	<td>
									      		<a href="<?php echo e(route('candidate/admineditcandidate',$get_candidate->users_id)); ?>" class="actionbtn">
									      			<i class="fa fa-pencil" aria-hidden="true"></i>
									      		</a>
	      										<a href="javascript:void(0);" class="actionbtn deletedcandidate" id="<?php echo $get_candidate->users_id; ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/candidate/candidatedetail.blade.php ENDPATH**/ ?>