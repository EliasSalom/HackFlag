...
setInterval(function(){																								
		var candidate_id = <?php echo $candidate->id ?>;            		            
                $.ajax({
                type:'POST',
                url:"<?php echo e(route('hackedinfo')); ?>",
                data:{"_token": "<?php echo e(csrf_token()); ?>",candidate_id:candidate_id},
...
</html><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/includes/footer.blade.php ENDPATH**/ ?>