		...
		<div class="col-md-8">
				...
				<div class="logo">
					...
					<a href="javascript:void(0);">
						...
						<p class="text-center"><img src="<?php echo e(URL::asset('/images/logo.png')); ?>" alt="Logo" /></p>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="flagbox">
								...
								<label><?php echo e($candidate->first_name); ?> <?php echo e($candidate->last_name); ?></label>

								<label><?php echo e($candidate->username); ?></label>
	...
	$(document).on('keypress', '.getdetails', function(e){
		...
		var command = $(this).val();
		 ...
		 {		 	
				...
				url:"<?php echo e(route('runcommand')); ?>",

				data:{"_token": "<?php echo e(csrf_token()); ?>",candidate_id:candidate_id,command:command,game_id:game_id},
...
setInterval(function(){																								
		...
		var game_id = <?php echo $game_id; ?>;            		            
                ...
                url:"<?php echo e(route('gamestartstatus')); ?>",

                data:{"_token": "<?php echo e(csrf_token()); ?>",candidate_id:candidate_id,game_id:game_id},
            ...
            $.ajax({
                ...
                url:"<?php echo e(route('hackstatus')); ?>",
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoarrj1n/public_html/Hackflag/Development/resources/views/front/gamestart.blade.php ENDPATH**/ ?>